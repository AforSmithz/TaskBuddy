// Amazon RDS certificate authority for ap-southeast-1.
//
// GENERATED by aws/scripts/fetch-rds-ca.sh. Do not hand-edit; re-run the script.
// Source: https://truststore.pki.rds.amazonaws.com/ap-southeast-1/ap-southeast-1-bundle.pem
//
...
//
// Valid to 2121, so this is not a rotation treadmill; re-run the script only if
// AWS publishes a new regional root.
